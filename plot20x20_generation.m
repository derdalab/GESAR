...
SAVEfile = ''; % keep blank if don't want to save
SET{1} = 19:21; % B-SX4, captured: size 6e7 PFU
SET{2} = 22:24; % SX74, captured: size 2e4 PFU
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
SAVEDir = '';
saveIMG = 'YEBreactive1';
SAVEto = 'YEBreactive1.txt';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% most common SDB is the SX4 SDB #1:
j=1;
SDB{j} = ['~~~~~~' uSDB{j} '~~~~~~~~~~~~~~~~~~~~~~~~'];
SX4 = 'AG~~~~~~~~~~~~~GG~GG~GG~';
...
Fr1 = Fr ( reliable, :);
inFr = inFr(reliable, :);
%% This is where I calculate the Si, form which I then calculate the C
for i =1 : numel(SET)
...
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This is the MOST IMPORTANT LINE, this is where I calculate the conversion
% it is calculated from Si (PFU-like values), which is
